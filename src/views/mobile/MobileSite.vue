<template>
  <div style="width: 100%; background: #000; height: 100%; position: relative">
    ...
    <div class="hn_c" ref="block1">
      ...
      <div class="card">
        <div class="c_body">
          <img src="../../assets/livecasino/servicegirl1.jpg" alt="" />
      ...
      <div class="card">
        <div class="c_body">
          <img src="../../assets/livecasino/servicegirl2.jpg" alt="" />
          <font color="#fff">凯博娱乐</font>
          <p>
            您想要的都在这里，平台有实力，游戏质量有保障 <br />
            多玩少玩，多少要玩，早赢晚赢，早晚要赢
    ...
    <div class="download" ref="block2">
      ...
      <div class="qr_code">
        <img src="../../assets/mobile/qr2.jpg" alt="" />
...
export default {
  data() {
    return {
      ...
      cList: [
        { img: require("../../assets/home/d1.jpg") },
        { img: require("../../assets/home/d5.jpg") },
        { img: require("../../assets/home/d3.jpg") },
        { img: require("../../assets/home/d4.jpg") },
        { img: require("../../assets/home/dd.jpg") },
      ],
      scrollImg: [
        {
...
.active {
  color: rgb(231, 231, 154) !important;
}
.carousal {
  height: 580px;
  margin-top: 210px;
